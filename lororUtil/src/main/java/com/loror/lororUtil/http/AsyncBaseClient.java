...
public class AsyncBaseClient<T extends HttpURLConnection> extends BaseClient<T> {
	...
	public synchronized void asyncDownload(final String urlStr, final String path, final boolean cover,
	...
	public synchronized void asyncDownloadInPeice(final String urlStr, final String path, final long start,
